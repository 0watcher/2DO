...
class [[nodiscard]] UserDb {
  public:
    ...
    [[nodiscard]] tdl::Result<User, UsrDbErr> get_user(
        const String& username) const;
    [[nodiscard]] tdl::Result<User, UsrDbErr> get_user(int id) const;
    [[nodiscard]] tdl::Result<tdl::Id, UsrDbErr> get_user_id(
        const String& username) const;
    [[nodiscard]] bool is_empty() const;

    tdl::Result<void, UsrDbErr> add_user(User& user);
    tdl::Result<void, UsrDbErr> delete_user(const String& username);
    tdl::Result<void, UsrDbErr> delete_user(int id);
    tdl::Result<void, UsrDbErr> update_data(const User& user);
